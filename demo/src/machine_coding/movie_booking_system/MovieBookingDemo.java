...
import machine_coding.movie_booking_system.entities.*;
import machine_coding.movie_booking_system.enums.SeatStatus;
import machine_coding.movie_booking_system.enums.SeatType;
import machine_coding.movie_booking_system.strategy.payment.CreditCardPaymentStrategy;
import machine_coding.movie_booking_system.strategy.pricing.WeekdaysPricingStrategy;
...
public class MovieBookingDemo {
    public static void main(String[] args) {
        ...
        System.out
                .println("Alice selects seats: "
                        + desiredSeats.stream().map(Seat::getSeatId).collect(Collectors.toList()));
        ...
        if (bookingOpt.isPresent()) {
            ...
            System.out
                    .println("Seats: " + booking.getSeats().stream().map(Seat::getSeatId).collect(Collectors.toList()));
