...
import machine_coding.movie_booking_system.strategy.pricing.PricingStrategy;
...
public class MovieBookingService {
    ...
    public Cinema addCinema(String id, String name, String cityId, List<Screen> screens) {
        ...
        cinemas.put(cinema.getCinemaId(), cinema);
        return cinema;
    }
    ...
    public Optional<Booking> bookTickets(String userId, String showId, List<Seat> desiredSeats,
    ...
    private Cinema findCinemaForShow(Show show) {
        // This is inefficient. In a real system, shows would have a direct link to the
        // cinema.
