...
import machine_coding.tictactoe.entities.Player;
...
public class TicTacToeDemo {
    public static void main(String[] args) {
        ...
        system.makeMove(alice, 2, 1); // X at (1,0) - No effect, game already won
        system.makeMove(bob, 1, 2); // O at (1,0) - No effect, game already won
