package machine_coding.stackoverflow;

import java.util.List;
import java.util.Set;

import machine_coding.stackoverflow.entities.Answer;
import machine_coding.stackoverflow.entities.Question;
import machine_coding.stackoverflow.entities.Tag;
import machine_coding.stackoverflow.entities.User;
import machine_coding.stackoverflow.enums.VoteType;
import machine_coding.stackoverflow.strategy.SearchStrategy;
import machine_coding.stackoverflow.strategy.TagSearchStrategy;
import machine_coding.stackoverflow.strategy.UserSearchStrategy;
...
public class StackOverflow {
    public static void main(String[] args) {
        ...
        Question question = service.postQuestion(alice.getId(), "How to implement Observer Pattern?",
