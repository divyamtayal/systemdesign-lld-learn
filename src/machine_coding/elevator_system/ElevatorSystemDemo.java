...
public class ElevatorSystemDemo {
    public static void main(String[] args) throws InterruptedException {
        ...
        int numElevators = 2;
        // The getInstance method now initializes the elevators and attaches the Display
        // (Observer).
        ...
        // The system will dispatch this to the nearest elevator (likely E1 or E2, both
        // at floor 1).
        ...
        // Note: In a real simulation, we'd wait until E1 reaches floor 5, but for this
        // demo,
