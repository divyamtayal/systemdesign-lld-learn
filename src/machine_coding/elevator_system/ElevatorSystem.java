package machine_coding.elevator_system;
...
import machine_coding.elevator_system.enums.RequestSource;
import machine_coding.elevator_system.observer.Display;
import machine_coding.elevator_system.startegy.ElevatorSelectionStrategy;
import machine_coding.elevator_system.startegy.NearestElevatorStrategy;
...
public class ElevatorSystem {
    ...
    public void requestElevator(int floor, Direction direction) {
        ...
        Optional<Elevator> selectedElevator = selectionStrategy.selectElevator(new ArrayList<>(elevators.values()),
                request);
