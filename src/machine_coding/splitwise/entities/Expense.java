package machine_coding.splitwise.entities;

import java.time.LocalDateTime;
import java.util.List;

import machine_coding.splitwise.strategy.SplitStrategy;
...
public class Expense {
    ...
    private Expense(ExpenseBuilder builder) {
        ...
        this.splits = builder.splitStrategy.calculateSplits(builder.amount, builder.paidBy, builder.participants,
                builder.splitValues);
    }
