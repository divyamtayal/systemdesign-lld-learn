...
import machine_coding.parking_lot.entities.*;
import machine_coding.parking_lot.enums.VehicleSize;
import machine_coding.parking_lot.strategy.fee.VehicleBasedFeeStrategy;
...
public class ParkingLotDemo {
    public static void main(String[] args) {
        ...
        System.out.println("\n--- Vehicle Entries ---");
        floor1.displayAvailableSpots();
        floor2.displayAvailableSpots();
