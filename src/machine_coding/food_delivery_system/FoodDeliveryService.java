...
import machine_coding.food_delivery_system.strategy.assignment.DeliveryAssignmentStrategy;
...
public class FoodDeliveryService {
    ...
    public void cancelOrder(String orderId) {
        ...
        if (order.cancel()) {
            ...
            System.out.println(
                    "FAILED: Order " + orderId + " could not be canceled. Its status is: " + order.getStatus());
        }
    }
