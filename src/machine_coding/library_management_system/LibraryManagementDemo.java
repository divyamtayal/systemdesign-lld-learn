package machine_coding.library_management_system;

import java.util.*;

import machine_coding.library_management_system.entites.*;
import machine_coding.library_management_system.enums.ItemType;
import machine_coding.library_management_system.strategy.*;
...
public class LibraryManagementDemo {
        public static void main(String[] args) {
                ...
                library.checkout(charlie.getId(), hobbitCopies.get(0).getId()); // Charlie fails to check out The Hobbit
                                                                                // copy 1
                ...
                library.checkout(alice.getId(), duneCopies.get(0).getId()); // Alice fails, it's checked out by Charlie
                                                                            // now.
