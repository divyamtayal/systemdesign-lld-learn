package machine_coding.car_rental_system;

import java.time.LocalDate;
import java.util.*;

import machine_coding.car_rental_system.entities.Bill;
import machine_coding.car_rental_system.entities.Customer;
import machine_coding.car_rental_system.entities.Equipment;
import machine_coding.car_rental_system.entities.Location;
import machine_coding.car_rental_system.entities.Reservation;
import machine_coding.car_rental_system.entities.Vehicle;
import machine_coding.car_rental_system.enums.EquipmentType;
import machine_coding.car_rental_system.enums.VehicleType;
import machine_coding.car_rental_system.observer.EmailNotificationObserver;
import machine_coding.car_rental_system.observer.InvoiceObserver;
import machine_coding.car_rental_system.strategy.StandardPricingStrategy;
import machine_coding.car_rental_system.strategy.WeekendPricingStrategy;
